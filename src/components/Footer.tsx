        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              {/* Pinterest */}
              <a href="https://www.pinterest.com" className="text-gray-400 hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Quick Links */}
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/HowItWorks" className="text-gray-300 hover:text-white transition-colors">How It Works</Link></li>
                <li><Link to="/DonorRegistration" className="text-gray-300 hover:text-white transition-colors">Become a Donor</Link></li>
                <li><Link to="/HospitalRegistration" className="text-gray-300 hover:text-white transition-colors">Hospital Registration</Link></li>
              </ul>
            </div>
            ...
            {/* Support */}
               <div>
                 ...
                 <ul className="space-y-2">
                   ...
                   <li><Link to="/emergency-hotline" className="text-gray-300 hover:text-white transition-colors">Emergency Hotline</Link></li>
                 </ul>
               </div>
