      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-dark-text mb-4">For Donors</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">Become a hero in just a few simple steps</p>
          </div>
            ...
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="text-center">
                <div className="relative mb-6">
                  <div className="w-20 h-20 bg-red-600 dark:bg-red-700 rounded-full flex items-center justify-center mx-auto shadow-lg">
                    <span className="text-white text-2xl font-bold">{step}</span>
                  </div>
                  {step !== 4 && (
                    <div className="hidden md:block absolute top-10 left-full w-full h-0.5 bg-red-200 dark:bg-red-400 -translate-y-0.5"></div>
                  )}
                </div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {step === 1 && "Sign up and provide your basic information, blood type, and location"}
                  {step === 2 && "Receive real-time SOS alerts when hospitals near you need your blood type"}
                  {step === 3 && "Choose to help and get instant contact details of the requesting hospital"}
                  {step === 4 && "Visit the hospital and donate blood to save precious lives"}
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-dark-text mb-4">For Hospitals</h2>
            <p className="text-lg text-gray-600 dark:text-gray-300">Get the blood you need, when you need it</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="text-center">
                <div className="relative mb-6">
                  <div className="w-20 h-20 bg-blue-600 dark:bg-blue-700 rounded-full flex items-center justify-center mx-auto shadow-lg">
                    <span className="text-white text-2xl font-bold">{step}</span>
                  </div>
                  {step !== 4 && (
                    <div className="hidden md:block absolute top-10 left-full w-full h-0.5 bg-blue-200 dark:bg-blue-400 -translate-y-0.5"></div>
                  )}
                </div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-dark-text mb-3">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  {step === 1 && "Register your hospital and get verified by our team for authenticity"}
                  {step === 2 && "Create urgent blood requests with specific requirements and urgency level"}
                  {step === 3 && "Receive instant responses from nearby donors willing to help"}
                  {step === 4 && "Manage donor visits and track blood collection through your dashboard"}
                </p>
              </div>
            ))}
          </div>
        ...
        {/* Key Features */}
        <div className="bg-white dark:bg-dark-card rounded-2xl p-8 md:p-12">
          <h2 className="text-3xl font-bold text-center text-gray-900 dark:text-dark-text mb-12">Key Features</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Real-time Alerts", icon: "M13 10V3L4 14h7v7l9-11h-7z", desc: "Instant notifications for urgent blood requirements" },
              { title: "Location-based Matching", icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z", desc: "Connect with the nearest available donors" },
              { title: "Verified Network", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", desc: "All hospitals and donors are verified for safety" },
              { title: "Mobile-First", icon: "M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z", desc: "Optimized for mobile devices for quick access" },
              { title: "Analytics Dashboard", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z", desc: "Track donations and manage requests efficiently" },
              { title: "24/7 Availability", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", desc: "Round-the-clock service for emergency situations" },
            ].map((feature, idx) => (
              <div key={idx} className="text-center p-6">
                ...
                <h3 className="text-lg font-bold text-gray-900 dark:text-dark-text mb-2">{feature.title}</h3>
