...
<head>
  ...
  <title>RaktDaan - connect the donors</title>
    ...
    <article>
      ...
      <section class="section hero" id="home" style="background-image: url('./assets/images/hero-bg.png')"
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <p class="section-subtitle">RaktDaan</p>
            <h1 class="h1 hero-title">Contact Us</h1>
            <h2 style="color: var(--royal-blue-light);">Address</h2>
            <p class="hero-text">
              RaktDaan, Vaikom Road, Near Thalook Headquarters<br>
      ...
      <footer class="footer">
        ...
        <div class="footer-bottom">
          <div class="container">
            <p class="copyright">
              &copy; 2024 All Rights Reserved by RaktDaan
            </p>
            <ul class="social-list">
              <li>
                <a href="https://www.facebook.com/andro.pool.54?mibextid=ZbWKwL" class="social-link">
